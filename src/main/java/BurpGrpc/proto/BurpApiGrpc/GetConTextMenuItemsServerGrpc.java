...
public final class GetConTextMenuItemsServerGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "BurpMorePossibilityApi.GetConTextMenuItemsServer";
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getConTextMenuItems(BurpGrpc.proto.BurpApiGrpc.Str request,
  ...
  /**
   * Base class for the server implementation of the service GetConTextMenuItemsServer.
   * <pre>
   * 获取上下文菜单项服务器  发送菜单项的名字
   * </pre>
   */
  public static abstract class GetConTextMenuItemsServerImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return GetConTextMenuItemsServerGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service GetConTextMenuItemsServer.
   * <pre>
   * 获取上下文菜单项服务器  发送菜单项的名字
   * </pre>
   */
  public static final class GetConTextMenuItemsServerStub
      extends io.grpc.stub.AbstractAsyncStub<GetConTextMenuItemsServerStub> {
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service GetConTextMenuItemsServer.
   * <pre>
   * 获取上下文菜单项服务器  发送菜单项的名字
   * </pre>
   */
  public static final class GetConTextMenuItemsServerBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<GetConTextMenuItemsServerBlockingStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service GetConTextMenuItemsServer.
   * <pre>
   * 获取上下文菜单项服务器  发送菜单项的名字
   * </pre>
   */
  public static final class GetConTextMenuItemsServerFutureStub
      extends io.grpc.stub.AbstractFutureStub<GetConTextMenuItemsServerFutureStub> {
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              BurpGrpc.proto.BurpApiGrpc.MenuInfo>(
                service, METHODID_GET_CON_TEXT_MENU_ITEMS)))
        .build();
  }
  ...
  private static final class GetConTextMenuItemsServerMethodDescriptorSupplier
    ...
    GetConTextMenuItemsServerMethodDescriptorSupplier(java.lang.String methodName) {
